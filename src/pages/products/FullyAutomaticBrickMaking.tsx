...
const FullyAutomaticBrickMaking = () => {
    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="bg-industrial-800 text-white py-20 mt-20">
        <div className="container mx-auto px-4">
          ...
          <h1 className="text-4xl md:text-5xl font-bold mb-4 font-poppins">
            Fully Automatic Brick Making Plant
          </h1>
          <p className="text-xl text-gray-300 max-w-3xl">
            High-capacity automated brick production lines with advanced controls for consistent quality output.
          </p>
        </div>
      </div>
      ...
      <div className="py-16">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <img
              src="https://images.unsplash.com/photo-1487958449943-2429e8be8625?w=800&h=500&fit=crop"
              alt="Fully Automatic Brick Making Plant"
      ...
      <div className="py-16 bg-industrial-800 text-white">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-3xl font-bold mb-4 font-poppins">Get a Quote for Brick Making Plant</h2>
...
export default FullyAutomaticBrickMaking;
