...
const SemiAutomaticBrickMaking = () => {
    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="bg-industrial-800 text-white py-20 mt-20">
        <div className="container mx-auto px-4">
          ...
          <p className="text-xl text-gray-300 max-w-3xl">
            Cost-effective brick making solutions ideal for medium-scale production with manual assistance.
          </p>
        </div>
      </div>
      ...
      <div className="py-16">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <img
              src="https://images.unsplash.com/photo-1486718448742-163732cd1544?w=800&h=500&fit=crop"
              alt="Semi-Automatic Brick Making Machines"
      ...
      <div className="py-16 bg-industrial-800 text-white">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-3xl font-bold mb-4 font-poppins">Get a Quote for Semi-Automatic Machines</h2>
...
export default SemiAutomaticBrickMaking;
