        ...
        <div className="flex items-center justify-between">
          ...
          <div className="hidden lg:flex items-center space-x-8">
            <button 
              ...
              className="text-industrial-700 hover:text-orange-600 font-medium transition-colors"
            >
              Home
            </button>
            <button 
        ...
        {isMobileMenuOpen && (
          <div className="lg:hidden mt-4 pb-4 border-t border-industrial-200">
            <div className="flex flex-col space-y-4 pt-4">
              <button 
                onClick={() => scrollToSection('home')}
                className="text-left text-industrial-700 hover:text-orange-600 font-medium"
              >
                Home
              </button>
              <button 
