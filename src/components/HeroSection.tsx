...
const HeroSection = () => {
  ...
  const slides = [
    ...
    {
      image: "https://images.unsplash.com/photo-1565191999001-551c187427bb?w=1200&h=600&fit=crop",
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center text-white">
            <h1 className="text-4xl md:text-6xl font-bold mb-6 font-poppins animate-fade-in">
              ...
              <span className="text-orange-400">Fly Ash Handling</span> & <br />
              <span className="text-orange-400">Brick Making Plants</span>
            </h1>
